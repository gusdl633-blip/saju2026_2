...
import { SajuProfile, SajuReading, CATEGORIES, generateSajuReading } from './services/geminiService';
...
export default function App() {
  ...
  return (
    <div className="min-h-screen flex flex-col relative overflow-hidden">
      ...
      <header className="p-6 flex justify-between items-center z-50">
        ...
        >
          ...
          <div className="flex flex-col">
            ...
            <span className="text-[10px] text-neon-primary font-bold tracking-widest uppercase opacity-60">
              Futuristic Saju
            </span>
          </div>
        </div>
      ...
      <main className="flex-1 container mx-auto px-6 py-4 z-10">
      ...
      <footer className="p-10 text-center space-y-3 z-10">
        ...
        <p className="text-[10px] text-text-sub/40 uppercase tracking-[0.3em]">
          © 2026 천명(天命) - Futuristic Saju System
        </p>
